...
<body id="home_page" class="home_page">
		...
		<section>
			<div class="main">
				...
				<form action="<%=request.getContextPath()%>/SignUp" method="post">
					<span class="ungiven">first name</span><input class="un"
						name="firstName" type="text" placeholder="FIRST NAME" required /><br>
					<span class="ungiven">last name</span><input class="un"
						name="lastName" type="text" placeholder="LAST NAME" required /><br>
					<span class="ungiven">gender</span><select class="un" name="gender">
						<option value="male">Male</option>
						<option value="male">Female</option>
						<option value="male">others</option>
					</select><br> <span class="ungiven">date of birth</span><input
						class="un" name="dateOfBirth" type="date" required /><br> <span
						class="ungiven">mobile no</span><input class="un"
						name="contactDetail" type="tel" placeholder="MOBILE NO." required /><br>

					<span class="ungiven">user name</span><input class="un username"
						name="userName" type="tel" placeholder="USERNAME" required /><br>
					<span class="ungiven">Email</span><input class="un email"
						name="emailAddress" type="email" placeholder="@abc.com" required /><br>
					<span class="ungiven">password</span><input class="un username"
						name="password" type="password" placeholder="PASSWORD" required /><br>
					<span class="ungiven">password</span><input class="un username"
		...
		<div class="container">
			<div class="row">
				<div class="col-md-3 col-sm-12">
					<a href="index.jsp"><img src="images/logofooter.png" alt="#"
				...
				<div class="col-md-3 col-sm-12">
					...
					<div class="address_infor">
						<p>
							<span class="icon"><img src="images/location_icon.png"
								alt="#" /></span> <span class="addrs">202,Karol bagh, Delhi</span>
						</p>
					</div>
				</div>
				...
				<div class="col-md-3 col-sm-12">
					...
					<div class="social_icon">
						<ul>
							<li><a href="#"><img src="images/in.png" alt="#"
							...
							<li><a href="#"><img src="images/gp.png" alt="#"
									width="33" height="33" /></a></li>
	...
	<script src="https://kit.fontawesome.com/b7801006ce.js"
